...
def get_fullday():
    ...
    for i in range(8):
        ...
        time = re.findall(r"\d.:00", date_time)[0]
...
def search():
    ...
    weather_button.place(x=67, y=60)
    map_button.place(x=137, y=60)

# gets activated by the weather button, it disappears the map and places the weather labels
def show_weather():
    map_widget.place_forget()
...
# gets activated by the map button, it disappears the weather labels and places the map
def show_map():
    location_label.place_forget()
    icon_label.place_forget()
    description_label.place_forget()
    temperature_label.place_forget()
    fd1_label.place_forget()
    fd2_label.place_forget()
    fd3_label.place_forget()
    fd4_label.place_forget()
    fd5_label.place_forget()
    fd6_label.place_forget()
    fd7_label.place_forget()
    fd8_label.place_forget()
    fd1_image.place_forget()
    fd2_image.place_forget()
    fd3_image.place_forget()
    fd4_image.place_forget()
    fd5_image.place_forget()
    fd6_image.place_forget()
    fd7_image.place_forget()
    fd8_image.place_forget()
    fd1_temp.place_forget()
    fd2_temp.place_forget()
    fd3_temp.place_forget()
    fd4_temp.place_forget()
    fd5_temp.place_forget()
    fd6_temp.place_forget()
    fd7_temp.place_forget()
    fd8_temp.place_forget()
    today_label.place_forget()
    d1_label.place_forget()
    d2_label.place_forget()
    d3_label.place_forget()
    d4_label.place_forget()
    todaymin_label.place_forget()
    d1min_label.place_forget()
    d2min_label.place_forget()
    d3min_label.place_forget()
    d4min_label.place_forget()
    todaymax_label.place_forget()
    d1max_label.place_forget()
    d2max_label.place_forget()
    d3max_label.place_forget()
    d4max_label.place_forget()
    today_image.place_forget()
    d1_image.place_forget()
    d2_image.place_forget()
    d3_image.place_forget()
    d4_image.place_forget()
    map_widget.place(x=50, y=110)
...
weather_button = ttkbootstrap.Button(root, text="Weather", command=show_weather)
map_button = ttkbootstrap.Button(root, text="Map", command=show_map)
...
city_entry.place(x=5, y=10)
search_button.place(x=5, y=60)
